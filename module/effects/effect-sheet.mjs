...
export class StreetFighterEffectSheet extends ActiveEffectConfig {
  ...
  _getEffectTargetTypes() {
    return [
      ...
      { value: EFFECT_TARGET_TYPES.MANEUVER_TECHNIQUE_SPEED, label: game.i18n.localize("STREET_FIGHTER.ActiveEffects.TargetTypes.maneuverTechniqueSpeed") },
      { value: EFFECT_TARGET_TYPES.MANEUVER_TECHNIQUE_DAMAGE, label: game.i18n.localize("STREET_FIGHTER.ActiveEffects.TargetTypes.maneuverTechniqueDamage") },
      { value: EFFECT_TARGET_TYPES.MANEUVER_TECHNIQUE_MOVEMENT, label: game.i18n.localize("STREET_FIGHTER.ActiveEffects.TargetTypes.maneuverTechniqueMovement") },
      { value: EFFECT_TARGET_TYPES.MANEUVER_SPECIFIC_SPEED, label: game.i18n.localize("STREET_FIGHTER.ActiveEffects.TargetTypes.maneuverSpecificSpeed") },
      { value: EFFECT_TARGET_TYPES.MANEUVER_SPECIFIC_DAMAGE, label: game.i18n.localize("STREET_FIGHTER.ActiveEffects.TargetTypes.maneuverSpecificDamage") },
      { value: EFFECT_TARGET_TYPES.MANEUVER_SPECIFIC_MOVEMENT, label: game.i18n.localize("STREET_FIGHTER.ActiveEffects.TargetTypes.maneuverSpecificMovement") },
    ];
  }
